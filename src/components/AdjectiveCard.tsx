...
const AdjectiveCard: FC<AdjectiveCardProps> = ({ isCorrect, currentAdjective, currentConjugationType, isIncorrect, isSettingsOpen, setIsSettingsOpen }) => {
  return (
      ...
      {isCorrect ? (
        <>
          <div className="text-slate-100 bg-green-600 p-3 rounded-md antialiased animate-fade-in">
            ...
            <h1 className="text-8xl font-extrabold ">
              {currentAdjective[currentConjugationType]}
            </h1>
          </div>

          <div className="flex flex-col gap-2 animate-fade-in">
            <div className="text-slate-100 bg-green-600 p-3 rounded-md ">
              <h4 className="text-2xl">{currentAdjective.type}</h4>
        ...
        <>
          <div className="dark:text-slate-100 bg-slate-200 dark:bg-neutral-800 p-4 rounded-md antialiased animate-fade-in">
            <h3 className="text-4xl font-extrabold">{currentAdjective.hiragana}</h3>
            <h1 className="text-9xl font-extrabold ">{currentAdjective.kanji}</h1>
          </div>

          <div className="flex gap-2 flex-col">
            <div className="dark:text-slate-100 bg-slate-200 dark:bg-neutral-800 p-3 rounded-md animate-fade-in h-fit">
              <h2 className="text-6xl font-bold">{currentAdjective.english}</h2>
